...
public class ByteUtil {
    ...
    public static String getBalanceShort(String data) {
        String s1 = data.substring(0, 2);
        String s2 = data.substring(2, 4);
        String s3 = data.substring(4, 6);
        return s3 + s2 + s1;
    }
    ...
    public static String toBinaryString(String cardNoType) {
        String type = Integer.toBinaryString(Integer.parseInt(cardNoType));
        switch (type.length()) {
            case 1:
                type = "0000000" + type;
                break;
