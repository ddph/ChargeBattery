package com.clound.battery.view.countdown;
...
//        Log.d("aaaa", "ms:"+ms+" minute:"+minute+" second:"+second+" millisecond:"+millisecond);
    ...
    public String toString() {
        return "CountdownView{" +
                "mCountdown=" + mCountdown.toString() +
                ", mCustomCountDownTimer=" + mCustomCountDownTimer.toString() +
                ", mOnCountdownEndListener=" + mOnCountdownEndListener +
                ", mOnCountdownIntervalListener=" + mOnCountdownIntervalListener +
                ", isHideTimeBackground=" + isHideTimeBackground +
                ", mPreviousIntervalCallbackTime=" + mPreviousIntervalCallbackTime +
                ", mInterval=" + mInterval +
